...
import xyz.xbeeegsone.outdatedprotocol.rewriters.LoginRewriter;
...
public class ExtraLoginPacket extends LoginPacket {
    ...
    public void decode() {
        ...
        if(this.protocol <= 113) {
            LoginRewriter loginRewriter = new LoginRewriter(this.username, 113, this.clientUUID, this.clientId, this.skin);
            //super.cacheBuffer = loginRewriter.createCacheBuffer();
        }
