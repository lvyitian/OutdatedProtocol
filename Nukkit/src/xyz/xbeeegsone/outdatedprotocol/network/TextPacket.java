...
public class TextPacket extends cn.nukkit.network.protocol.TextPacket {
    ...
    public void decode() {
        ...
        super.parameters = this.parameters;
    }
/*
    @Override
    public void encode() {
    ...
    public void encode() {
        this.reset();
        this.putByte(super.type);
        switch (super.type) {
            case TYPE_POPUP:
            case TYPE_CHAT:
            case TYPE_WHISPER:
            case TYPE_ANNOUNCEMENT:
                this.putString(super.source);
            case TYPE_RAW:
            case TYPE_TIP:
            case TYPE_SYSTEM:
                this.putString(super.message);
                break;

            case TYPE_TRANSLATION:
                this.putString(super.message);
                this.putUnsignedVarInt(super.parameters.length);
                for (String parameter : super.parameters) {
                    this.putString(parameter);
                }
        }
    }
